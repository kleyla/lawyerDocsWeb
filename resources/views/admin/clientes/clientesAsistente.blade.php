...
<div class="content">
        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    ...
                    {{-- <Button class="btn-icon btn-primary alingleft"  size="sm" data-toggle="modal" data-target="#clienteAdd">
    ...
    <div class="modal modal-black show" id="clienteAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 pr-md-1">
                            <div class="form-group">
                                ...
                                <select name="genero" class="form-control" data-style="btn btn-link" id="exampleFormControlSelect1">                       
...
@if ( $clientes != null )
    <div class="modal fade" id="delClienteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
